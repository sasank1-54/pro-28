...
function moreAboutHome(address, distanceFromTown, hasNeighbours){
    let add = address
    let dist = distanceFromTown
    let hasN = hasNeighbours
    return typeof(add)+typeof(dist)+typeof(hasN)
}
...
function moreAboutKaren(parent, noOfSiblings, isNuclearFamily){
    let count = 0
...
function consoleKaren(strategy){
